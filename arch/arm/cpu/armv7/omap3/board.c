...
{
#if (LSD_DEBUG > 0)
	puts("lierda debug:enter File=armv7/omap3/board.c,Function=omap_boot_mode\n");	
#endif
...
#if (LSD_DEBUG > 0)
	puts("lierda debug:enter File=armv7/omap3/board.c,Function=s_init\n");	
#endif
}
...
void watchdog_init(void)
{
	...
	#if (LSD_DEBUG > 0)
	puts("lierda debug:enter File=armv7/omap3/board.c,Function=watchdog_init\n");	
	#endif
